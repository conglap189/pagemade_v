...
export const header1 = {
    id: 'header-1',
    label: 'Header 1 - Simple Nav',
    category: '0. Header Section',
    media: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        <rect x="2" y="4" width="20" height="6" rx="1" fill="currentColor" fill-opacity="0.1"/>
        <line x1="5" y1="7" x2="7" y2="7" stroke-width="2"/>
        <line x1="17" y1="7" x2="19" y2="7" stroke-width="2"/>
        <rect x="2" y="12" width="20" height="8" rx="1" stroke-dasharray="2 2"/>
    </svg>`,
    content: `
        <section class="pm-header-1">
            <style>
                /* Wrapper style để đảm bảo component hiển thị tốt trong canvas */
                .pm-header-1 {
                    width: 100%;
                    font-family: system-ui, -apple-system, sans-serif;
                }
                /* Lưu ý: Component này sử dụng Tailwind CSS gốc từ code bạn cung cấp. 
                   Đảm bảo dự án PageMade của bạn đã tích hợp Tailwind CSS. */
            </style>
                ...
                <div class="flex flex-1 items-center justify-end md:justify-between">
                  <nav aria-label="Global" class="hidden md:block">
                    <ul class="flex items-center gap-6 text-sm">
                      ...
                      <li><a class="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75" href="#">History</a></li>
                      ...
                      <li><a class="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75" href="#">Blog</a></li>
                    </ul>
                  </nav>

                  <div class="flex items-center gap-4">
                    <div class="sm:flex sm:gap-4">
                      <a class="block rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-teal-700 dark:hover:bg-teal-500" href="#">Login</a>
                      <a class="hidden rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600 transition hover:text-teal-600/75 sm:block dark:bg-gray-800 dark:text-white dark:hover:text-white/75" href="#">Register</a>
                    </div>
