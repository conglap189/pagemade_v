...
(function() {
    ...
    // Load from local build (grapesjs/packages/core/dist/pagemade.min.js copied to public/)
    // Use absolute path to avoid relative path issues
    script.src = '/editor/public/pagemade-core.min.js';
    script.onload = function() {
        ...
        if (window.pm && window.pm.init) {
            ...
            console.log('🔧 Based on GrapeJS 0.22.13 - Built from local source');
        } else {
            console.error('❌ PageMade loaded but init function not found');
        }
    };
    script.onerror = function() {
        console.error('❌ Failed to load PageMade Editor core from local');
        console.error('💡 Make sure pagemade-core.min.js exists in public/ folder');
    };
